export const colorDefault = ["#FF0000", "#8B00FF", "#00FF00", "#FF6600", "#00C7FF",
...
export const colorDaltonic = ["#0000FF", "#FFFF00", "#FFA500", "#FFC0CB", "#800080",
...
export const colorSequential = ["#EAF8E8", "#B4E5BB", "#8AD495", "#62C96F", "#44B95B",
...
export const colorDivergent = ["#5DA9DA", "#F6B542", "#74C980", "#EE82B5", "#B9A538",
