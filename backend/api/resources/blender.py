...
def generate_gltf(csv_path, gltf_path):
    ...
    for i, row in df.iterrows():
        ...
        # Create a UV sphere
        bpy.ops.mesh.primitive_uv_sphere_add(location=(0, 0, 0), segments = z, ring_count = y, radius = value, calc_uvs = True)
